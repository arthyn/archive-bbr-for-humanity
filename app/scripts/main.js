...
function setupSmallLayout(page) {
	var cards = $('.card');
	var card = (document.getElementsByClassName('card'))[3];
	card = card.cloneNode(true);
	card.firstChild.innerHTML = '';

	var numCardsToGenerate = cardPhrases.length - cards.length + 2;
